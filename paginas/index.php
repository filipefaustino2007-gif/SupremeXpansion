...
<body>
    ...
    <section class="why-supreme">
        ...
        <div class="text-side">
            ...
            <div class="topics">
                <p><a href="" class="subtitulo">Experiência e Qualidade de Trabalho</a> - Mais de 25 anos de experiência e tecnologia de ponta garantem precisão e detalhe em cada levantamento e modelo 3D.</p>
                <br>
                <p><a href="" class="subtitulo">Tecnologia e Ferramentas</a> - Utilizamos tecnologias 2D e 3D avançadas, entregando resultados fiáveis, eficientes e prontos a integrar nos seus projetos.</p>
                <br>
                <p><a href="" class="subtitulo">Preço Acessível</a> - Qualidade técnica a preços justos, ajustados a projetos de qualquer dimensão — de pequenas reabilitações a grandes empreendimentos.</p>
                <br>
                <p><a href="" class="subtitulo">Excelente Suporte ao Cliente</a> - Acompanhamento próximo e transparente em todas as fases, com apoio contínuo e total dedicação ao cliente.</p>
            </div>
        </div>
    </section>
