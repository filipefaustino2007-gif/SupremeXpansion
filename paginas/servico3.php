...
<body>
    ...
    <section class="galeria-catalogo" data-gallery="servico3">
        <div class="galeria-grid">
            ...
            <!-- Linha 3 -->
            <img class="grid-img gallery-item-wide" src="../img/servico3_17.png" alt="Galeria 13">
            <img class="grid-img gallery-item-wide" src="../img/servico3_18.png" alt="Galeria 14">
            <img class="grid-img gallery-item-wide" src="../img/servico3_19.png" alt="Galeria 15">
            <img class="grid-img gallery-item-wide" src="../img/servico3_20.png" alt="Galeria 16">
            <img class="grid-img gallery-item-wide" src="../img/servico3_21.png" alt="Galeria 17">
        </div>
    </section>
