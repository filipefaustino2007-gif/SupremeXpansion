...
<body>
    ...
    <section class="servico-modelacao">
        <div class="servico-modelacao-texto">
            <h2>Modelação 3D</h2>
            <p>
                Criamos modelos 3D precisos e realistas, adaptados a cada projeto. Combinamos tecnologia avançada com uma equipa
                experiente em arquitetura, engenharia e design para garantir qualidade, cumprimento de prazos e total satisfação
                dos nossos clientes.
            </p>
        </div>
